...
if (playerHasKey && didDefeatDragon) {
  console.log(
    "The player ventures forth into the dungeon, dragon heart in hand"
  );
} else if (playerHasKey) {
  console.log(
    `The door squeeks open: ${playerName} feels a cool rush of wind and a sense of dread.`
  );
} else if (didDefeatDragon) {
  console.log(
    `The door refuses to open: in the distance, a loud roar. ${evilVillan} approaches`
  );
} else {
